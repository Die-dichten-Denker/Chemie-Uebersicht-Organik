...
\date{\today}
\author{Baden, Julian\\Gymnasium Mellendorf\\ABI Jahr 2027}
...
\textbf{Radikale Substitution}, aus Alkanen, ein Halogen addiert wurde. \\
...
\begin{center}
    \chemfig{H-C(-[:90]H)(-[:270]Br)-C(-[:90]Br)(-[:270]H)-H} \hspace{1cm} \textbf{Trans-1,2-dibromethan}\\[0,5cm]
    \chemfig{H-C(-[:90]H)(-[:270]Br)-C(-[:90]H)(-[:270]Br)-H} \hspace{1cm} \textbf{Cis-1,2-dibromethan}\\[0,5cm]
\end{center}
